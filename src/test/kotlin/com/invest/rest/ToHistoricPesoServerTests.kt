...
@ActiveProfiles("test")
class ToHistoricPesoServerTests
    @Autowired
    constructor(val mockMvc: MockMvc) {
        private val baseUrl = "/v1/currency/historic/peso"

        @Test
        fun `to historic peso endpoint exists`() {
            val uriWithParam =
        ...
        @Test
        fun `can convert 1 dollar to peso with CCL quotation of 2002-10-01`() {
            val pesos = 1.0
        ...
        @Test
        fun `can convert 3 dollars to peso with CCL quotation of 2002-10-02`() {
            val pesos = 3.0
            val quotation = Quotation.CCL
